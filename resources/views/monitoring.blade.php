...
<body class="bg-slate-900 text-white flex flex-col min-h-screen">
    ...
    <main class="flex-grow p-6">
        ...
        <div class="mt-6 bg-slate-800 p-6 rounded-xl">
            ...
            <input id="textNear" maxlength="32" placeholder="Teks < 50 cm" class="text-black p-2 rounded w-full mb-2">

            <input id="textFar" maxlength="32" placeholder="Teks >= 50 cm" class="text-black p-2 rounded w-full mb-2">
